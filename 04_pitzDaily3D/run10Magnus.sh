...
#Preparing the case ..........
####srun --export=all -n 1 blockMesh -fileHandler collated
####srun --export=all -n 1 renumberMesh -overwrite -fileHandler collated
####srun --export=all -n 1 decomposePar -force -fileHandler collated
...
#Running the case ..........
#srun --export=all -n $SLURM_NTASKS --unbuffered pimpleFoam -parallel -fileHandler collated
...
module list
echo "----------------------------------------"
srun --export=all -n $SLURM_NTASKS --unbuffered pimpleDarshanFoam -parallel -fileHandler collated

#Running the case with pat_run  ..........
###module load perftools-preload
###srun --export=all -n $SLURM_NTASKS --unbuffered pat_run -z pm="mpi" /group/director782/espinosa/software/cle60up05/apps/PrgEnv-gnu/6.0.4/gcc/5.3.0/haswell/openfoam+/v1812/OpenFOAM-v1812/platforms/linux64CrayDPInt32Opt/bin/pimpleFoam -parallel -fileHandler collated
